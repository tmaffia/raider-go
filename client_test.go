...
func TestGetGuildBossKill(t *testing.T) {
	testCases := []struct {
		...
		{region: regions.US, difficulty: raiderio.Difficulty.MythicRaid,
			realm: "invalid-realm", guildName: "warpath", raidSlug: "vault-of-the-incarnates",
			bossSlug: "terros", expectedErrMsg: "invalid realm"},
		{region: regions.US, difficulty: raiderio.Difficulty.MythicRaid,
			guildName: "warpath", raidSlug: "vault-of-the-incarnates",
			bossSlug: "terros", expectedErrMsg: "invalid realm"},
		{region: regions.US, difficulty: raiderio.Difficulty.MythicRaid, realm: "illidan",
...
func TestGetRaidRankings(t *testing.T) {
	testCases := []struct {
		...
		{slug: "aberrus-the-shadowed-crucible", difficulty: raiderio.Difficulty.MythicRaid, region: regions.WORLD,
			expectedRank1GuildName: "Liquid"},
		{slug: "aberrus-the-shadowed-crucible", difficulty: raiderio.Difficulty.MythicRaid, region: regions.US,
		...
		{slug: "invalid raid slug", difficulty: raiderio.Difficulty.MythicRaid, region: regions.US, realm: "illidan",
			expectedErrMsg: "invalid raid"},
		...
		{slug: "aberrus-the-shadowed-crucible", difficulty: "invalid-difficulty", region: regions.US, realm: "illidan",
			expectedErrMsg: "invalid raid difficulty"},
		{slug: "", difficulty: raiderio.Difficulty.MythicRaid, region: regions.US, realm: "illidan",
			expectedErrMsg: "invalid raid name"},
		{slug: "aberrus-the-shadowed-crucible", difficulty: raiderio.Difficulty.MythicRaid, region: regions.WORLD,
			expectedRank1GuildName: "Liquid", limit: 20},
		{slug: "aberrus-the-shadowed-crucible", difficulty: raiderio.Difficulty.MythicRaid, region: regions.WORLD, limit: -20,
			expectedErrMsg: "limit must be a positive int"},
		{slug: "aberrus-the-shadowed-crucible", difficulty: raiderio.Difficulty.MythicRaid, region: regions.US,
			expectedRank1GuildName: "Accession", limit: 40, page: 2},
		{slug: "aberrus-the-shadowed-crucible", difficulty: raiderio.Difficulty.MythicRaid, region: regions.US, limit: 40,
			page: -2, expectedErrMsg: "page must be a positive int"},
		{timeout: true, slug: "aberrus-the-shadowed-crucible", difficulty: raiderio.Difficulty.MythicRaid, region: regions.US,
			expectedErrMsg: "raiderio api request timeout"},
	}
